...
#Reading Train Data
mat=scipy.io.loadmat("C:\\sarthak\\CEDT IISC\\Data Sets\\cifar_10_data_batch_1.mat")
data_set_train_1=np.concatenate((np.matrix(mat['labels']),np.matrix(mat['data'])),axis=1)
mat=scipy.io.loadmat("C:\\sarthak\\CEDT IISC\\Data Sets\\cifar_10_data_batch_2.mat")
data_set_train_2=np.concatenate((np.matrix(mat['labels']),np.matrix(mat['data'])),axis=1)
mat=scipy.io.loadmat("C:\\sarthak\\CEDT IISC\\Data Sets\\cifar_10_data_batch_3.mat")
data_set_train_3=np.concatenate((np.matrix(mat['labels']),np.matrix(mat['data'])),axis=1)
mat=scipy.io.loadmat("C:\\sarthak\\CEDT IISC\\Data Sets\\cifar_10_data_batch_4.mat")
data_set_train_4=np.concatenate((np.matrix(mat['labels']),np.matrix(mat['data'])),axis=1)
mat=scipy.io.loadmat("C:\\sarthak\\CEDT IISC\\Data Sets\\cifar_10_data_batch_5.mat")
data_set_train_5=np.concatenate((np.matrix(mat['labels']),np.matrix(mat['data'])),axis=1)
data_set_train=np.concatenate((data_set_train_1,data_set_train_2,data_set_train_3,data_set_train_4,data_set_train_5))

#Reading Test Data
mat=scipy.io.loadmat("C:\\sarthak\\CEDT IISC\\Data Sets\\cifar_10_test_batch.mat")
data_set_test=np.concatenate((np.matrix(mat['labels']),np.matrix(mat['data'])),axis=1)

#############################################################################
#Comment the following line if do not want to add test data to training data#
#############################################################################
#data_set_train=np.concatenate((data_set_train,data_set_test))
#############################################################################
...
data_set_train_features=data_set_train[:,1:]
data_set_test_features=data_set_test[:,1:]
...
print("SVD Calculation Starts::")
U1, S1, V1= np.linalg.svd(data_set_train_features, full_matrices=False)
print("SVD Calculation Ends::")

S1=S1.reshape(-1,1)

#for f_sel in range(15,f_sel_max,10):
...
#    print("Normal SVD Ends::")
    ...
    data_set_train_reduced=np.concatenate((data_set_train[:,0],data_set_train_features_reduced),axis=1)
    data_set_test_reduced=np.concatenate((data_set_test[:,0],data_set_test_features_reduced),axis=1)
...
plt.figure(1)
plt.plot(f_sel_list,acc_list,'b',label='Validation Accuracy (CIFAR-10)')
